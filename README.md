...
## Environments
- Preview: https://main--edge-delivery-forms--danetesu27.hlx.page/
- Live: https://main--edge-delivery-forms--danetesu27.hlx.live/
...
1. Open the `edge-delivery-forms` directory in your favorite IDE and start coding :)
